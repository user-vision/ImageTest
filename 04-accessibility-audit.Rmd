...
| Ranking | Definition |
|:--- |:--- |
| Positive (P) | An example of good practise which should be maintained.                          	                            |
| High (H) | An issue which would prevent one or more disability groups from being able to use the site as intended.            |
| Medium (M) |  An issue which would cause one or more disability groups significant difficulty using the site as intended. 	|
| Low (L) | An issue which would cause one or more disability groups some inconvenience when using the site as intended. 	    |
| Observation (O) | Not necessarily an accessibility concern, but an area on the site which could cause a usability issue.    	|
